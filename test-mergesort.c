...
int main(int argc, char **argv) {
  ...
  //   printf("Unsorted array (first 100 elements):\n");
  //   printA();
  ...
  // print the sorted array (commented out after testing)
  ...
  /* Now we can free the memory for the two arrays. */
  /* Removed free arg since it's already freed by parallel_mergesort() */
  free(B);
  free(A);
